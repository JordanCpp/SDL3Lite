...
#ifndef SDL3Lite_Video_h
#define SDL3Lite_Video_h
...
#define SDL_WINDOW_FULLSCREEN           (1)    /**< window is in fullscreen mode */
#define SDL_WINDOW_OPENGL               (2)    /**< window usable with OpenGL context */
#define SDL_WINDOW_OCCLUDED             (3)    /**< window is occluded */
#define SDL_WINDOW_HIDDEN               (4)    /**< window is neither mapped onto the desktop nor shown in the taskbar/dock/window list; SDL_ShowWindow() is required for it to become visible */
#define SDL_WINDOW_BORDERLESS           (5)    /**< no window decoration */
#define SDL_WINDOW_RESIZABLE            (6)    /**< window can be resized */
#define SDL_WINDOW_MINIMIZED            (7)    /**< window is minimized */
#define SDL_WINDOW_MAXIMIZED            (8)    /**< window is maximized */
#define SDL_WINDOW_MOUSE_GRABBED        (9)    /**< window has grabbed mouse input */
#define SDL_WINDOW_INPUT_FOCUS          (10)    /**< window has input focus */
#define SDL_WINDOW_MOUSE_FOCUS          (11)    /**< window has mouse focus */
#define SDL_WINDOW_EXTERNAL             (12)    /**< window not created by SDL */
#define SDL_WINDOW_MODAL                (13)    /**< window is modal */
#define SDL_WINDOW_HIGH_PIXEL_DENSITY   (14)    /**< window uses high pixel density back buffer if possible */
#define SDL_WINDOW_MOUSE_CAPTURE        (15)    /**< window has mouse captured (unrelated to MOUSE_GRABBED) */
#define SDL_WINDOW_MOUSE_RELATIVE_MODE  (16)    /**< window has relative mode enabled */
#define SDL_WINDOW_ALWAYS_ON_TOP        (17)    /**< window should always be above others */
#define SDL_WINDOW_UTILITY              (18)    /**< window should be treated as a utility window, not showing in the task bar and window list */
#define SDL_WINDOW_TOOLTIP              (19)    /**< window should be treated as a tooltip and does not get mouse or keyboard focus, requires a parent window */
#define SDL_WINDOW_POPUP_MENU           (20)    /**< window should be treated as a popup menu, requires a parent window */
#define SDL_WINDOW_KEYBOARD_GRABBED     (21)    /**< window has grabbed keyboard input */
#define SDL_WINDOW_VULKAN               (22)    /**< window usable for Vulkan surface */
#define SDL_WINDOW_METAL                (23)    /**< window usable for Metal view */
#define SDL_WINDOW_TRANSPARENT          (24)    /**< window with transparent buffer */
#define SDL_WINDOW_NOT_FOCUSABLE        (25)    /**< window should not be focusable */
